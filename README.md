...
3.	The International Journal of Medical Physics Research and Practice
...
August 2015 — April 2020
         ...
         Publication.1: “Adversarial Attacks and Defenses against Deep Neural Networks: A Survey,” Mesut Ozdag. Procedia Computer Science, vol. 140, pp. 152 – 161, 2018. Cyber Physical Systems and Deep Learning Chicago, Illinois November 5-7, 2018.
•	This paper presents the vulnerability of deep learning models against adversarial input samples. It demonstrates the methods of adversarial attacks and defenses. Furthermore, it shows comparisons amongst each other and does analysis. The contribution of this survey is significant on this era of machine learning in security-sensitive environments.
...
- Python, C++, Matlab, SQL
- Tensorflow, PyTorch, Keras, Theano, Scikit-learn
...
- MRI quality QC classification
- Federated learning.
- Cancer prognosis prediction.
- Adversarial attacks on fingerprints.
- Vessel Centerline Tracing with Reinforcement Learning.
- Track Points in Video using Kanade-Lucas-Tomasi Algorithm.
- Graph-Cut 3-D Medical Image Segmentation.
